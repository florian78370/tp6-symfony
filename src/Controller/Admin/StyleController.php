...
class StyleController extends AbstractController
{
    ...
    public function AjoutermodifStyle(?Style $style=null, Request $request, EntityManagerInterface $manager) : Response
    {
        if ($style == null) {
             $style=new Style();
             $mode="ajouté";
    ...
    #[Route('/admin/style/suppression/{id}', name: 'admin_style_suppression', methods : ["DELETE"])]
    public function suppresionStyle(?Style $style,EntityManagerInterface $manager) : Response
    { 
