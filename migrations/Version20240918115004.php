 ...
 */
final class Version20240918115004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE morceau (id INT NOT NULL, album_id INT NOT NULL, titre VARCHAR(255) NOT NULL, durée VARCHAR(255) NOT NULL, INDEX IDX_36BB72081137ABCF (album_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
